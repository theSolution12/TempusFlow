    ...
    <div class="w-1/2 flex items-center justify-center p-8 bg-gray-100">
      <form action="./backend/register.php" method="post" class="w-full max-w-sm" onsubmit="return validateForm()">
        ...
        <div class="mb-4">
          ...
          <input class="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500" type="text" id="username" name="username" placeholder="Username" required />
        ...
        <div class="mb-6">
          ...
          <input class="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500" type="password" id="confirmPassword" name="confirmPassword" placeholder="••••••••" required />
