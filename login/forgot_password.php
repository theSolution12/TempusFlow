...
<body class="w-screen h-screen flex items-center justify-center">
  ...
  <div class="w-full max-w-4xl h-5/6 bg-white shadow-lg rounded-lg overflow-hidden flex">
    ...
    <div class="w-1/2 flex items-center justify-center p-8 bg-gray-100">
      <form action="./backend/forgot_password.php" method="post" class="w-full max-w-sm" onsubmit="return validateForm()">
        ...
        <div class="mb-4">
          ...
          <input class="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500" id="email" name="email" type="email" placeholder="you@example.com" />
        ...
        <input type="submit" value="Submit" class="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 transition" />
      </form>
    </div>
